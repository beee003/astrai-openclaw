...
All LLM calls now route through Astrai. Check savings anytime:
...
OpenClaw Agent
     |
     v
[Astrai Skill]  ← intercepts LLM calls
     |
     v
[Astrai API]    ← classifies task → picks optimal model/provider
     |
     v
[Best Provider] ← Anthropic, OpenAI, Google, Mistral, etc.
     |
     v
...
|---|---|---|
| `ASTRAI_API_KEY` | Your API key | Required |
